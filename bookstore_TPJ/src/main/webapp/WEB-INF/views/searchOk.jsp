...
<body>
	...
	<div class="main_title" style="margin-top: 170px">
		<div class="container">
				...
				<section class="login">
					<article class="login__form__container">
						...
						<div class="login__form">
							<!--로고-->
			            <div class="book_logo mt-5 mb-2" style="width: 280px; margin-top: 90px"> 
	                       <a href="/main"> <img src="/resources/img/bk_store2.png"></a>
							...
							<c:if test="${mypasid != null}">
								<form class="login__input" action="/pasupdate" method="post" id="pasFrm" name="pasFrm">
									...
									<button type="button" class="btn btn-primary" id="pasUp" value="비빌번호변경" style="width: 250px; margin-left: 40px; margin-top: 20px">비빌번호변경</button>
								</form>
							</c:if>
						...
						<br/>
						<!--계정이 있으신가요?-->
						<div class="login__register" style="margin-top: 50px; margin-left: 100px">
							<a href="/login">
