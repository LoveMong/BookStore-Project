				...
				<section class="login">
					<article class="login__form__container">
						...
						<div class="login__form">
							...
							<p style="margin-top: 60px">비밀번호 찾기 </p>
							<!--로고end-->
							<!--아이디찾기 인풋-->
							...
							<!-- <input type="text" name="user_id" placeholder="유저네임" required="required" id="user_id"> -->
								...
								<div id="main_id" class="form-floating mb-3" style="width: 330px">
								...
								<div id="mail_sign_ch" class="form-floating d-none" style="width: 330px">
								...
								<br/>
								<br/>
								<button type="button" class="btn btn-primary" id="searchId" value="비밀번호찾기" style="width: 250px; margin-left: 40px">비밀번호 찾기</button>
								<br/>
												
								<a href="/idsearch"> <span class="badge bg-success" style="margin-top: 10px; margin-left: 60px; width: 100px; height: 25px; line-height: 15px; float: left; margin-top: 35px">아이디찾기</span></a>
		                     	<a href="/passearch"> <span class="badge bg-success" style="margin-top: 10px; width: 100px; margin-left: 10px; line-height: 15px; height: 25px; margin-top: 35px">비밀번호찾기</span></a>
